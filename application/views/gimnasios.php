...
<section id="canchas">
    ...
    <div class="container">
        <?php foreach ($gimnasios as $gimnasio){
            ...
            echo "<div class='row'><a href='".base_url()."index.php/gimnasios/ver_info/".$gimnasio->id_gym."'>";
            echo "<h2>".$gimnasio->Nombre."</h2>";
            echo "</a><div class='col-lg-3'>";
            $img_tag  = "<img class=\"img-responsive hidden-xs\" src=\"".base_url()."/assets/images/";
            $img_tag .= $gimnasio->Imagen;
            $img_tag .= "\" width='300px' height='300px'alt=\"\"/>";
            echo $img_tag;
            echo "</div>";
            echo "<div class='col-lg-9'>";
            echo "<p>".$gimnasio->Descripcion."</p>";
            echo "</div>";
            echo "</div>";
